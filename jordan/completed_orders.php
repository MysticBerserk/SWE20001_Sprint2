...
<html lang="en">
    ...
    <body>
        ...
        <?php
            include ("completed_orders_process.php");
        ...
        <header><h1>Completed Orders</h1></header>
        
        <form action = "completed_orders_process.php" method = "POST">
            <div class = "order1">
            ...
            <div class = "order_amount">
                <h2 id = "order_amount">Completed Orders: <?php echo $resultCheck?></h2>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <div class = "order_list_row">
                                ...
                                <div class = "order_list_flex2">
                                    <a class = "order_list_button" href="completed_orders_process.php?delete=<?php echo $row['id']; ?>">Delete</a>
                                </div>
                            </div> 
